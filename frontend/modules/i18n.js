...
export const I18N = {
  'zh-CN': {
    login_title: 'Onyx', login_sub: '使用企业账号安全登录', sso_btn: '企业账号登录（SSO）', sso_hint: '通过 JarvisBIM 身份验证登录',
    ...
    integ_wecom_hint: '填写你的企业微信邮箱和登录密码，系统通过 IMAP 拉取邮件摘要（仅读取标题和发件人，不读正文）。',
    integ_wecom_email_label: '邮箱地址', integ_wecom_pwd_label: '邮箱密码',
    integ_telegram_hint: '将 Bot 拉入群聊，群内 @Bot 的消息会自动分析并创建任务建议。从 @BotFather 获取 Token。',
    integ_disconnect: '断开', integ_disconnected: '已断开',
  ...
  'zh-HK': {
    login_title: 'Onyx', login_sub: '使用企業賬號安全登錄', sso_btn: '企業賬號登錄（SSO）', sso_hint: '透過 JarvisBIM 身份驗證登錄',
    ...
    integ_wecom_hint: '填寫你的企業微信郵箱和登入密碼，系統透過 IMAP 拉取郵件摘要（僅讀取標題和寄件人，不讀正文）。',
    integ_wecom_email_label: '郵箱地址', integ_wecom_pwd_label: '郵箱密碼',
    integ_telegram_hint: '將 Bot 拉入群聊，群內 @Bot 的消息會自動分析並建立任務建議。從 @BotFather 取得 Token。',
    integ_disconnect: '斷開', integ_disconnected: '已斷開',
  ...
  'en': {
    login_title: 'Onyx', login_sub: 'Sign in with your enterprise account', sso_btn: 'Enterprise Login (SSO)', sso_hint: 'Authenticate via JarvisBIM',
    ...
    integ_wecom_hint: 'Enter your WeCom email and login password. The system pulls email summaries via IMAP (subject & sender only, not body).',
    integ_wecom_email_label: 'Email address', integ_wecom_pwd_label: 'Email password',
    integ_telegram_hint: 'Add the bot to a group chat. Messages @mentioning the bot are analyzed and turned into task suggestions. Get the token from @BotFather.',
    integ_disconnect: 'Disconnect', integ_disconnected: 'Disconnected',
