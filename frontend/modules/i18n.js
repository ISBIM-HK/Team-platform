...
export const I18N = {
  'zh-CN': {
    ...
    admin_roles: '角色', admin_groups: '组别',
    group_select_hint: '选择左侧组别查看成员', group_add_sub: '新建子组',
    group_rename: '重命名', group_archive: '归档', group_add_member: '添加成员',
    group_no_members: '暂无成员', group_name_prompt: '请输入组名',
    group_archived: '已归档', group_created: '已创建',
    invite_by_group: '按组邀请', invite_groups_btn: '邀请选中的组', select_groups: '请先选择组',
    transfer_lead_first: '请先将其他成员设为 lead 再操作', remove_self_confirm: '确定将自己移出项目吗？',
  ...
  'zh-HK': {
    ...
    admin_roles: '角色', admin_groups: '組別',
    group_select_hint: '選擇左側組別查看成員', group_add_sub: '新建子組',
    group_rename: '重命名', group_archive: '歸檔', group_add_member: '添加成員',
    group_no_members: '暫無成員', group_name_prompt: '請輸入組名',
    group_archived: '已歸檔', group_created: '已建立',
    invite_by_group: '按組邀請', invite_groups_btn: '邀請選中的組', select_groups: '請先選擇組',
    transfer_lead_first: '請先將其他成員設為 lead 再操作', remove_self_confirm: '確定將自己移出項目嗎？',
  ...
  'en': {
    ...
    admin_roles: 'Roles', admin_groups: 'Groups',
    group_select_hint: 'Select a group to view members', group_add_sub: 'New Sub-group',
    group_rename: 'Rename', group_archive: 'Archive', group_add_member: 'Add Member',
    group_no_members: 'No members yet', group_name_prompt: 'Enter group name',
    group_archived: 'Archived', group_created: 'Created',
    invite_by_group: 'Invite by group', invite_groups_btn: 'Invite selected groups', select_groups: 'Select groups first',
    transfer_lead_first: 'Transfer lead role to another member first', remove_self_confirm: 'Remove yourself from this project?',
